...
public class NhaCungCapJDialog extends javax.swing.JInternalFrame {
    ...
    private String check(String btn) {
        ...
        if (!checkTrung() && btn.equals("Them")) {
            err += "Mã nhà cung cấp trùng ";
        } else {
            if (CheckData.isNull(txtMaNCC.getText()) && btn.equals("Them")) {
                err += "Mã nhà cung cấp không được để trống\n";
            }
            if (CheckData.isNull(txtTenNCC.getText())) {
                err += "Tên nhà cung cấp không được để trống\n";
            }
    ...
    private boolean checkTrung() {
        NhaCungCap h = dao.selectById(txtMaNCC.getText());
        if (h == null) {
            return true;
        } else {
            return false;
